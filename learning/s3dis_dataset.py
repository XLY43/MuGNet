...
def get_datasets(args, test_seed_offset=0):
    ...
    #             ,'WC_2.h5', 'storage_1.h5', 'storage_5.h5', 'conferenceRoom_2.h5', 'auditorium_1.h5'] #'auditorium_1.h5'
    valid_names = ['auditorium_1.h5', 'auditorium_2.h5']
        ...
        if n != args.cvfold:
            ...
            for fname in sorted(os.listdir(path)):
                if fname.endswith(".h5") and not (args.use_val_set and fname in valid_names):
                    ...
                    #print("spg added to trainlist", fname, spg.spg_reader(args, path + fname, True)[0].shape)
